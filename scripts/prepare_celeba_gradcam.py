...
if os.path.exists(AUX_DIR+'celeba_gradcam.hkl'):
    print("(pre-generated xai exists!)")
    print("... loading pre-generated xai ...")
    xai = hkl.load(AUX_DIR+'celeba_gradcam.hkl')
else:
    print("(no existing pre-generated xai!)")
    print("... generating xai ...")
    xai = GradCAM(victim_model).generate_gradcam_batched(imgs, return_as_ds=False, batch_size=64)
    hkl.dump(xai, AUX_DIR+'celeba_gradcam.hkl', mode='w')
