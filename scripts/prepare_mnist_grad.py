...
if os.path.exists(AUX_DIR+'mnist_grad.hkl'):
    ...
    xai = generate_grad_batched(victim_model, imgs, batch_size=256, return_as_ds=False)
    hkl.dump(xai, AUX_DIR+'mnist_grad.hkl', mode='w')
