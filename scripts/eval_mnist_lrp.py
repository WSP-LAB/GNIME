...
ckpt_dir = MODELS_DIR+'def/mnist_lrp/'
os.makedirs(ckpt_dir, exist_ok=True)
fig_dir = FIGURES_DIR+'def/mnist_lrp/'
...
xai = hkl.load(AUX_DIR+'mnist_lrp.hkl')[split_size:]
...
eval_xai = hkl.load(AUX_DIR+'mnist_lrp.hkl')[-7000:]
# perturb xai using def_model
...
model_path = MODELS_DIR+'inv/mnist_expmi_lrp'
