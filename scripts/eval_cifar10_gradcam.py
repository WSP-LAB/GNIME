...
ckpt_dir = MODELS_DIR+'def/cifar10_gradcam/'
os.makedirs(ckpt_dir, exist_ok=True)
fig_dir = FIGURES_DIR+'def/cifar10_gradcam/'
...
xai = hkl.load(AUX_DIR+'cifar10_gradcam.hkl')[split_size:]
...
inv_model = ExpMI(input_shape=(16,16,1), output_shape=(32,32,3), bottleneck_size=2048, with_conf=True, num_of_classes=10)
...
eval_xai = hkl.load(AUX_DIR+'cifar10_gradcam.hkl')[-6000:]
# perturb xai using def_model
...
model_path = MODELS_DIR+'inv/cifar10_expmi_gradcam'
