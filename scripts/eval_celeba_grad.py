...
xais = hkl.load(AUX_DIR+'celeba_grad.hkl')
...
ckpt_dir = MODELS_DIR+'def/celeba_grad/'
os.makedirs(ckpt_dir, exist_ok=True)
fig_dir = FIGURES_DIR+'def/celeba_grad/'
...
inv_model = ExpMI(input_shape=(128,128,3), output_shape=(128,128,3), bottleneck_size=2048, with_conf=True, num_of_classes=1000)
...
model_path = MODELS_DIR+'inv/celeba_expmi_grad'
