...
ckpt_dir = MODELS_DIR+'def/mnist_grad/'
os.makedirs(ckpt_dir, exist_ok=True)
fig_dir = FIGURES_DIR+'def/mnist_grad/'
os.makedirs(fig_dir, exist_ok=True)

xai = hkl.load(AUX_DIR+'mnist_grad.hkl')
...
xai = hkl.load(AUX_DIR+'mnist_grad.hkl')[split_size:]
...
inv_model = ExpMI(input_shape=(32,32,1), output_shape=(32,32,1), bottleneck_size=2048, with_conf=True, num_of_classes=10)
...
eval_xai = hkl.load(AUX_DIR+'mnist_grad.hkl')[-7000:]
# perturb xai using def_model
...
model_path = MODELS_DIR+'inv/mnist_expmi_grad'
