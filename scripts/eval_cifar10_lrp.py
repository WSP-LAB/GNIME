...
ckpt_dir = MODELS_DIR+'def/cifar10_lrp/'
os.makedirs(ckpt_dir, exist_ok=True)
fig_dir = FIGURES_DIR+'def/cifar10_lrp/'
os.makedirs(fig_dir, exist_ok=True)

xai = hkl.load(AUX_DIR+'cifar10_lrp.hkl')
...
xai = hkl.load(AUX_DIR+'cifar10_lrp.hkl')[split_size:]
...
eval_xai = hkl.load(AUX_DIR+'cifar10_lrp.hkl')[-6000:]
# perturb xai using def_model
...
model_path = MODELS_DIR+'inv/cifar10_expmi_lrp'
