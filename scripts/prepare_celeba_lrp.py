...
if os.path.exists(AUX_DIR+'celeba_lrp.hkl'):
    print("(pre-generated xai exists!)")
    print("... loading pre-generated xai ...")
    xai = hkl.load(AUX_DIR+'celeba_lrp.hkl')
else:
    ...
    lrps = LRP(victim_model, pool_type='avg').generate_batched(imgs, return_as_ds=False, batch_size=64)
    hkl.dump(lrps, AUX_DIR+'celeba_lrp.hkl', mode='w')